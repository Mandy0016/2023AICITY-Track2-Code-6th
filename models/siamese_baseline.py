...
supported_img_encoders = ["se_resnext50_32x4d","efficientnet-b2","efficientnet-b3","efficientnet-b5","efficientnet-b7"]
...
class SiameseBaselineModelv1(torch.nn.Module):
    def __init__(self, model_cfg):
        ...
        # self.bert_model = XLMRobertaXLModel.from_pretrained("xlm-roberta-xlarge")
    ...
    def forward(self, nl_input_ids,nl_attention_mask,crops, targets=None):
        ...
        out = {
            "pairs": [(visual_embeds, lang_embeds)],
