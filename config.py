...
_C.DATA.TRAIN_JSON_PATH = "your-path-to-data/train.json"
_C.DATA.EVAL_JSON_PATH = "your-path-to-data/val.json"
...
_C.DATA.TEST_TRACKS_JSON_PATH = "your-path-to-data/test-tracks.json"
...
# se_resnext50_32x4d, efficientnet-b2, efficientnet-b3
_C.MODEL.IMG_ENCODER = "se_resnext50_32x4d"
...
_C.MODEL.RESNET_CHECKPOINT = osp.join(
    os.environ['HOME'], '.cache/torch/hub/checkpoints/resnet50-19c8e357.pth')
...
_C.MODEL.HEAD.CLS_LOSS_SCALE = 48
...
_C.TEST.QUERY_JSON_PATH = "your-path-to-data/test-queries.json"
...
_C.INPUT.SIZE_TRAIN = [456, 456]
# Size of the image during test
_C.INPUT.SIZE_TEST = [456, 456]
