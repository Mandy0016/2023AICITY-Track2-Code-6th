...
from transformers import AutoTokenizer, XLMRobertaXLModel,BertTokenizer,RobertaTokenizer
import pickle
...
def main():
    ...
    for config_name in config_file_list:
        feat_pth_path = inference_vis_and_lang(config_name, args, enforced=False)
        print(feat_pth_path)
